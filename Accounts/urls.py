...
urlpatterns = [
    ...
    path("profile/blog/", login_required(views.ProfileBlogSectionView.as_view(), login_url="/Account/login/"),
         name="profileBlogView"),
    path("profile/update-user-data/",
         login_required(views.ProfileGetFullUserDataView.as_view(), login_url="/Account/login/"),
         name="profileUpdateUserDataView"),
